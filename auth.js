const handleRegistration = (event) => {
    ...
    if (password === confirm_password) {
      ...
      if (
        ...
        fetch("https://cloth-store-backend.onrender.com/register/", {
          method: "POST",
  ...
  const handleLogin = (event) => {
    ...
    if ((username, password)) {
      fetch("https://cloth-store-backend.onrender.com/login/", {
        method: "POST",
        headers: { "content-type": "application/json" },
  ...
  const handlelogOut = () => {
    ...
    fetch("https://cloth-store-backend.onrender.com/logout/", {
      method: "POST",
      headers: {
